...
> PostCSS 和 CSS 直接的关系就像 Babel 和 JavaScript 的关系，解除了语法上的禁锢，通过插件机制来扩展语言本身，用工程化手段给语言带来了更多的可能性。
...
> 本实例[提供项目完整代码](https://github.com/gwuhaolin/dive-into-webpack/tree/master/codes/3.5使用PostCSS)

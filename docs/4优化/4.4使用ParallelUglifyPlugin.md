...
为什么不把在[使用 ParallelUglifyPlugin](4.4使用ParallelUglifyPlugin.md)中介绍过的多进程并行处理的思想也引入到代码压缩中呢？
...
> 本实例[提供项目完整代码](https://github.com/gwuhaolin/dive-into-webpack/tree/master/codes/4.4使用ParallelUglifyPlugin)

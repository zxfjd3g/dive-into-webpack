...
接下来通过，修改前面讲过的[使用 ES6 语言](使用ES6语言.md)中的项目，为其接入 React 框架。
通过
```bash
# 安装 React 基础依赖
...
接下来通过修改前面讲过的[使用 TypeScript 语言](使用TypeScript语言.md)中的项目，为其接入 React 框架。
...
**本实例[完整代码下载](https://github.com/gwuhaolin/dive-into-webpack/tree/master/codes/使用React框架TypeScript)**
